...
def tree_summary_line(tree, level, print_line, print_amounts, zeros, credit_tree):
    ...
    tree_summary_lines(tree.subtrees(), level + 1, print_line, print_amounts, zeros, credit_tree)


def tree_summary_lines(trees, level, print_line, print_amounts, zeros, credit_tree):
    last_kind = None
    for tree in trees:
        ...
        if last_kind and last_kind != this_kind:
            print_line()
        last_kind = this_kind
        tree_summary_line(tree, level, print_line, print_amounts, zeros, credit_tree)
...
def tree_summary(tree, report_name="", period_name="", balance_name="", zeros=True, credit_tree=True, layout=None):
